...
<div class="absolute left-0 top-0 z-50 hidden h-screen w-full bg-wgg-white" id="mobile-menu">
    <div class="flex h-full flex-col justify-between p-4">
        <div class="space-y-4">
            ...
            <div class="mb-6 flex items-center justify-center">
                <svg class="text-wgg-black-950" width="48" height="48" viewBox="0 0 557 438" fill="none"
            ...
            <!-- Navigation Links -->
            <nav class="space-y-1">
                <a class="navbar-item {{ request()->routeIs('home') ? 'navbar-item-active' : 'navbar-item-active-hover' }}"
                    href="{{ route('home') }}">
                ...
                @auth
                    ...
                    @if (Auth::user()->role_id === 3)
                        <a class="navbar-item {{ request()->routeIs('claims.bulk-email') ? 'navbar-item-active' : 'navbar-item-active-hover' }}"
                ...
                @guest
                    <a class="navbar-item {{ request()->routeIs('login.form') ? 'navbar-item-active' : 'navbar-item-active-hover' }}"
                    ...
                    <a class="navbar-item {{ request()->routeIs('register') ? 'navbar-item-active' : 'navbar-item-active-hover' }}"
                        href="#">
                        <svg class="icon-small mr-3" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a class="flex items-center rounded-md px-4 py-2 text-sm font-medium text-gray-600 transition-all duration-300 ease-in-out hover:bg-gray-100 hover:text-gray-900"
                        href="#">
                        <svg class="icon-small mr-3" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        @auth
            <div class="mt-6 space-y-2">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button class="btn bg-red-500 font-medium text-white hover:bg-red-600" type="submit">
                        <svg class="icon-small mr-3" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
