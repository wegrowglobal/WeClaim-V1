...
<div id="mobile-menu" class="z-50 hidden absolute top-0 left-0 w-full h-screen bg-wgg-white">
    <div class="flex flex-col h-full justify-between p-4">
        <div class="space-y-4">
            ...
            <!-- Navigation Links -->
            <nav class="space-y-1">
                <a class="navbar-item {{ request()->routeIs('home') ? 'navbar-item-active' : 'navbar-item-active-hover' }}" href="{{ route('home') }}">
                ...
                @auth
                <a class="navbar-item {{ request()->routeIs('claims.dashboard') ? 'navbar-item-active' : 'navbar-item-active-hover' }}" href="{{ route('claims.dashboard') }}">
                    <svg class="icon-small mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a class="navbar-item {{ request()->routeIs('claims.approval') ? 'navbar-item-active' : 'navbar-item-active-hover' }}" href="{{ route('claims.approval') }}">
                    <svg class="icon-small mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a class="navbar-item {{ request()->routeIs('claims.new') ? 'bg-green-600 text-wgg-white hover:bg-green-800' : 'navbar-item-active-hover' }}" href="{{ route('claims.new') }}">
                    <svg class="icon-small mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a class="flex items-center px-4 py-2 text-sm font-medium rounded-md transition-all duration-300 ease-in-out text-gray-600 hover:bg-gray-100 hover:text-gray-900" href="#">
                    <svg class="icon-small mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mt-6 space-y-2">
            <a href="{{ route('profile') }}" class="btn bg-blue-500 hover:bg-blue-600 text-white font-medium">
                <svg class="icon-small mr-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
            ...
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="btn bg-red-500 hover:bg-red-600 text-white font-medium">
                    <svg class="icon-small mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
