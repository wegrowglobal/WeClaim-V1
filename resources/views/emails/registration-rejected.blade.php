...
<head>
    ...
    <title>Registration Rejected - WeClaim</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td>
                                        ...
                                        <h1 style="margin: 0 0 8px; color: #111827; font-size: 24px; font-weight: 600;">Registration Rejected</h1>
                                        <p style="margin: 0; color: #6B7280; font-size: 16px;">Your account registration request was not approved</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 24px 40px;">
                            ...
                            <p style="margin: 0 0 24px; color: #374151; font-size: 16px; line-height: 24px;">
                                We regret to inform you that your account registration request has been rejected.
                            </p>
                                            ...
                                            <tr>
                                                <td style="padding: 8px 16px;">
                                                    <p style="margin: 0; color: #991B1B; font-size: 14px; line-height: 20px;">
                                                        If you believe this was done in error, please contact your administrator or submit a new request.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
