...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-r from-wgg-black-950 to-black">
    <div class="bg-white p-10 rounded-xl shadow-2xl w-full max-w-md">
        ...
        <form method="POST" class="space-y-6" action=" ">
            ...
            <div>
                <button class="w-full py-3 px-5 border border-transparent rounded-md shadow-sm text-sm font-semibold text-white bg-wgg-black-950 hover:bg-wgg-black-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 ease-in-out" type="submit">Send Reset Link</button>
            </div>
        </form>

        <div class="mt-6 flex items-center justify-between">
            <div class="text-sm">
                <a href="{{ route('login') }}" class="font-medium text-wgg-black-600 hover:text-wgg-black-800">Remember Your Password?</a>
            </div>
        </div>
