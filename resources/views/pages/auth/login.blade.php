...
@section('content')
    <div
        class="flex min-h-[100dvh] w-full flex-col items-center justify-center gap-8 bg-gray-100 px-4 py-8 md:flex-row md:gap-6 md:py-0">
        ...
        <!-- Desktop Changelog -->
        <div class="w-full max-w-md md:max-w-xl hidden md:block">
