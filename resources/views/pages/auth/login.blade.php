...
@section('content')
    <div
        class="flex min-h-[100dvh] w-full items-center justify-center bg-gradient-to-br from-wgg-black-950 to-wgg-black-800">
                    ...
                    <div class="p-4">
                        <form class="space-y-4" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="relative">
                                ...
                                <input class="block w-full rounded-lg border-0 bg-gray-50 px-4 py-3 text-sm transition-all focus:bg-white focus:ring-2 focus:ring-indigo-600"
                                    id="email" 
                                    name="email" 
                                    type="email" 
                                    value="{{ old('email') }}" 
