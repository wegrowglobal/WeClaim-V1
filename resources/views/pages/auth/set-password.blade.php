        ...
        <div class="h-full w-full overflow-y-auto bg-white md:h-auto md:max-w-md md:rounded-3xl md:shadow-2xl">
            <div class="flex min-h-[100dvh] flex-col justify-center px-8 py-12 md:min-h-0">
                ...
                <div class="mb-8 text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500">Create a secure password for your account</p>
                </div>
                    ...
                    <div class="border-b border-gray-100 bg-gray-50 px-4 py-3">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Choose a strong password</p>
                            </div>
                        </div>
                    </div>

                    <div class="p-4">
                        <form class="space-y-4" method="POST" action="{{ route('password.setup', ['token' => $token]) }}">
                            @csrf
                            ...
                            <div class="relative">
                                ...
                                <input class="block w-full rounded-lg border-0 bg-gray-50 px-4 py-3 pr-10 text-sm transition-all focus:bg-white focus:ring-2 focus:ring-indigo-600 @error('password') border-red-300 @enderror"
                                    id="password"
                                    name="password"
                                    type="password"
                            ...
                            <div class="relative">
                                ...
                                <input class="block w-full rounded-lg border-0 bg-gray-50 px-4 py-3 pr-10 text-sm transition-all focus:bg-white focus:ring-2 focus:ring-indigo-600"
