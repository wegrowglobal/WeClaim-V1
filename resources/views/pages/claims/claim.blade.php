            ...
            <div class="p-10 space-y-8">
                ...
                <div class="space-y-2">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm">
                        <x-claim-table :rows="[
                            ['label' => 'Current Status', 'value' => '<x-status-badge :status="$claim->status" />'],
                ...
                <div class="space-y-2">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm">
                        <x-claim-table :rows="[
                            ...
                            ['label' => 'Toll Document', 'value' => '<a href="' . route('claims.view.document', ['claim' => $claim->id, 'type' => 'toll', 'filename' => $claim->documents->where('toll_file_name', '!=', null)->first()->toll_file_name ?? 'no-file']) . '" target="_blank" class="text-blue-600 hover:text-blue-900">View Toll Document</a>'],
                            ['label' => 'Email Approval', 'value' => '<a href="' . route('claims.view.document', ['claim' => $claim->id, 'type' => 'email', 'filename' => $claim->documents->where('toll_file_name', '!=', null)->first()->toll_file_name ?? 'no-file']) . '" target="_blank" class="text-blue-600 hover:text-blue-900">View Email Document</a>'],
                        ]" />
                    </div>
                </div>
