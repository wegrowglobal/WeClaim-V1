...
<div class="w-full max-w-md mx-auto px-6 py-12">
    ...
    <div class="mb-8 text-center">
        <h1 class="text-2xl font-bold text-black">Reset Your Password</h1>
        <p class="mt-2 text-sm text-gray-700">Enter your email and new password below.</p>
    </div>
    ...
    <form class="space-y-5" method="POST" action="{{ route('password.update') }}">
        ...
        <div>
            <label class="mb-1 block text-sm font-medium text-black" for="password">New Password</label>
            <div class="relative">
                ...
                <button type="button" 
                    ...
                    <svg id="password-toggle-icon" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                </button>
            </div>
            @error('password')
                <span class="mt-1 text-xs font-medium text-black">{{ $message }}</span>
        ...
        <div>
            <label class="mb-1 block text-sm font-medium text-black" for="password_confirmation">Confirm New Password</label>
            <div class="relative">
                <input class="block w-full rounded-md border border-gray-300 bg-white px-4 py-3 pr-10 text-sm transition focus:border-black focus:outline-none focus:ring-1 focus:ring-black"
                    ...
                    required>
                <button type="button" 
                        onclick="togglePasswordVisibility('password_confirmation', 'password_confirmation-toggle-icon')" 
                        class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-600">
                     <svg id="password_confirmation-toggle-icon" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                </button>
            </div>
        </div>
