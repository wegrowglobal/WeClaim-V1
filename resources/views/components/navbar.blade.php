    ...
    <div class="flex flex-col h-full justify-between p-4 rounded-lg shadow-lg border border-wgg-border">
        <div class="space-y-4">
            ...
            <nav class="space-y-1">
                ...
                <a class="flex items-center px-4 py-2 text-sm font-medium rounded-md transition-all duration-300 ease-in-out {{ request()->routeIs('claims.new') ? 'bg-green-600 text-wgg-white hover:bg-green-800' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}" href="{{ route('claims.new') }}">
                    <svg class="mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a class="flex items-center px-4 py-2 text-sm font-medium rounded-md transition-all duration-300 ease-in-out {{ request()->routeIs('register') ? 'bg-wgg-black-950 text-wgg-white hover:bg-wgg-black-800' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}" href=" ">
                    <svg class="mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mt-6 space-y-2">
            <a href="{{ route('profile') }}" class="w-full flex items-center px-4 py-2 border border-transparent text-sm font-semibold rounded-md text-white bg-blue-500 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-300 ease-in-out">
