                                ...
                                <tr class="*:text-xs *:text-gray-600 hover:bg-gray-50">
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-center">
                                        <a href="{{ route('claims.show', $claim->id) }}"
                                           class="inline-flex items-center justify-center rounded-lg bg-indigo-100 px-2 py-1 text-xs font-medium text-indigo-700 transition-colors hover:bg-indigo-200">
