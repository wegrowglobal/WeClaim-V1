...
<div class="bg-white rounded-lg shadow-sm ring-1 ring-black/5 animate-slide-in delay-200">
    <div class="px-4 sm:px-6 py-4 sm:py-5">
        <div class="flex items-center justify-between mb-4 sm:mb-6">
            <div>
                <h3 class="text-base sm:text-lg font-medium text-gray-900">Toll & Email Details</h3>
                <p class="text-xs sm:text-sm text-gray-500 mt-1">Toll & Email information and related documents</p>
            </div>
        </div>
