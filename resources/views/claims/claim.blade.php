        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="px-8 py-10">
                ...
                <div class="mt-6">
                    ...
                    @elseif ($claim->status == Claim::STATUS_REJECTED)
                        <a href="{{ route('claims.new', ['claim_id' => $claim->id]) }}" class="flex flex-row justify-center items-center w-fit gap-2 text-base px-4 py-2 bg-green-600 text-white font-semibold text-sm rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
                            Re-Submit Claim
