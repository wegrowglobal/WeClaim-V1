            ...
            <div class="p-10 space-y-4">
                ...
                <form action="{{ route('claims.update', $claim->id) }}" class="wgg-flex-col gap-4" method="POST">
                    ...
                    <div class="wgg-flex-row gap-2">
                        <button type="submit" name="action" value="approve" class="btn flex-center bg-green-400 hover:bg-green-600 gap-2">
                            Approve
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                            </svg>
                        </button>
                        <button type="submit" name="action" value="reject" class="btn flex-center bg-red-400 hover:bg-red-600 gap-2">
                            Reject
